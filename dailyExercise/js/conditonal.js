...
var selectNumber = Number(prompt('Enter a Number');

 selectNumber = (wouldLikeNumber, number) % 2  ? alert("Number is is even") : "Number is odd";
}
/*
if(wouldLikeNumber) {
    prompt("What number would you like to select? ");
}
if(number % 2) {
